...
# Brauzerdagi accept="video/*" faqat tanlash oynasiga ta'sir qiladi —
# uni chetlab o'tish oson, shuning uchun serverda ham tekshiramiz.
# (Shu sababdan hozir social_videos ichida bir nechta .jpg yotibdi.)
    ...
    if request.method == 'POST':
        ...
        if video:
            ...
            if ext not in VIDEO_EXTENSIONS:
                messages.error(
                    request,
                    'Bu fayl video emas. MP4 yoki MOV formatidagi video tanlang.'
                )
                return redirect('social:upload_video')
